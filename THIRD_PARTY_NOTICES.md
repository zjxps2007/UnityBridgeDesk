...
- **UnityBridge**: [zjxps2007/UnityBridge](https://github.com/zjxps2007/UnityBridge). 이 앱이 연결하는 외부 도구입니다. CLI·Connector 소스나 바이너리를 이 저장소에 포함하지 않습니다. 사용하는 배포본의 라이선스와 고지를 확인하세요.
